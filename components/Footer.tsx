  ...
  return (
    <footer className="py-16 md:py-32" id="contact">
      <div className="mx-auto max-w-5xl px-6">
        <div className="mb-16 rounded-xl text-white p-8 text-center">
          ...
          <Link
            href="#"
            className="inline-flex items-center gap-2 border border-white rounded-md px-6 py-3 font-medium hover:bg-white hover:text-black transition-colors duration-300"
          >
            Let's get in touch <FaArrowRight className="size-4" />
          </Link>
        </div>
