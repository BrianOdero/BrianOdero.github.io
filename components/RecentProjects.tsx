                ...
                <div key={id} className='lg:min-h-[32.5rem] h-[25rem] flex items-center justify-center sm:w-[570px] w-[80vw] my-30'>
                    <PinContainer title={link} href={link}>
                        <div className='relative flex items-center justify-center sm:w-[570px] w-[80vw] overflow-hidden sm:h-[40vh] h-[30vh] mb-10'>
                            ...
                            <img src={img} alt={title} className='z-10 absolute bottom-0 '/> {/**image of the project */}
                        </div>

                        <h1 className = "font-bold lg:text-2xl md:text-xl text-base line-clamp-1 my-4">
                            {title}
                        </h1>
                        ...
                        {/**mapping over the tech stack icons */}
