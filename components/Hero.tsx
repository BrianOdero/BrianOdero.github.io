...
function Hero() {
  return (
    <div className='pb-20 pt-36'>
      ...
      {/** welcoming texts on hero section */}
      <div className='flex justify-center relative my-20 z-10'>
        <div className='max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center'>
          <h2 className='uppercase tracking-widest text-xs text-center text-blue-100 max-w-80'>
           ...
           {/** dynamic styling of welcoming words */}
            <TextGenerateEffect
              className='text-center text-[40px] md:text-5xl lg:text-6xl'
              words='Transforming concepts to seamless user experiences'
            />

            <p className='text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl'>
              Hi, I'm Brian, An android developer and a full stack web developer proficient in Next Js and React Native frameworks
            </p>
